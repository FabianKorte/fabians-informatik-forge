...
export const wisoContent: LearnModule[] = [
  ...
  {
    type: "matching",
    title: "WiSo Begriffe zuordnen",
    pairs: [
      { left: "Betriebsrat", right: "Interessensvertretung der Arbeitnehmer" },
      { left: "Tarifautonomie", right: "Selbstbestimmung der Tarifparteien" },
      { left: "Kündigungsschutz", right: "Schutz vor ungerechtfertigter Kündigung" },
      { left: "Sozialversicherung", right: "System der sozialen Absicherung" },
      { left: "Inflation", right: "Allgemeiner Preisanstieg" },
      { left: "Deflation", right: "Allgemeiner Preisrückgang" },
      { left: "EU-Binnenmarkt", right: "Freier Verkehr von Waren, Personen, Dienstleistungen, Kapital" },
      { left: "Nachhaltigkeit", right: "Drei Säulen: Ökologie, Ökonomie, Soziales" }
    ]
  },
  {
    type: "dragdrop",
    title: "WiSo Kategorien",
    games: [
      {
        title: "Ordne die Sozialversicherungen zu",
        description: "Ziehe die Leistungen zu den richtigen Versicherungen",
        categories: ["Krankenversicherung", "Rentenversicherung", "Arbeitslosenversicherung", "Pflegeversicherung", "Unfallversicherung"],
        items: [
          { id: "krankengeld", content: "Krankengeld", category: "Krankenversicherung" },
          { id: "altersrente", content: "Altersrente", category: "Rentenversicherung" },
          { id: "arbeitslosengeld", content: "Arbeitslosengeld I", category: "Arbeitslosenversicherung" },
          { id: "pflegegeld", content: "Pflegegeld", category: "Pflegeversicherung" },
          { id: "berufsunfall", content: "Berufsunfallschutz", category: "Unfallversicherung" },
          { id: "reha", content: "Medizinische Reha", category: "Rentenversicherung" },
          { id: "weiterbildung", content: "Berufliche Weiterbildung", category: "Arbeitslosenversicherung" },
          { id: "pflegeberatung", content: "Pflegeberatung", category: "Pflegeversicherung" }
        ]
      }
    ]
  },
  {
    type: "scenario",
    title: "WiSo Praxisszenarien",
    scenarios: [
      {
        title: "Kündigung während Krankheit",
        description: "Rechtliche Bewertung einer Kündigungssituation",
        scenario: "Ein Mitarbeiter ist seit 8 Wochen krankgeschrieben. Das Unternehmen hat 15 Mitarbeiter, der Arbeitnehmer arbeitet seit 2 Jahren im Betrieb. Der Arbeitgeber möchte krankheitsbedingt kündigen. Ist das rechtlich möglich?",
        choices: [
          { text: "Ja, nach 6 Wochen Krankheit ist Kündigung automatisch möglich", consequence: "**Falsch:** Krankheit allein ist kein Kündigungsgrund. Kündigungsschutz gilt.", isCorrect: false },
          { text: "Nein, Kündigungsschutzgesetz verbietet krankheitsbedingte Kündigung", consequence: "**Richtig:** Bei 15+ Mitarbeitern und 2 Jahren Betriebszugehörigkeit gilt KSchG. Personenbedingte Kündigung nur bei dauerhafter Arbeitsunfähigkeit mit negativer Prognose möglich.", isCorrect: true },
          { text: "Ja, aber nur mit 4 Wochen Kündigungsfrist", consequence: "**Teilweise richtig:** Kündigungsfrist stimmt, aber soziale Rechtfertigung nach KSchG fehlt.", isCorrect: false },
          { text: "Kommt auf den Arbeitsvertrag an", consequence: "**Irrelevant:** Kündigungsschutzgesetz steht über Arbeitsvertragsklauseln.", isCorrect: false }
        ]
      },
      {
        title: "Tarifvertrag vs. Arbeitsvertrag",
        description: "Anwendung des Günstigkeitsprinzips",
        scenario: "Der Tarifvertrag sieht 30 Tage Urlaub vor, der Arbeitsvertrag gewährt nur 28 Tage. Ein neuer Mitarbeiter fragt, welche Regelung gilt. Beide Parteien (Arbeitnehmer und Arbeitgeber) sind tarifgebunden.",
        choices: [
          { text: "Arbeitsvertrag gilt, da individuell vereinbart", consequence: "**Falsch:** Tarifverträge haben Vorrang vor ungünstigeren Arbeitsvertragsklauseln.", isCorrect: false },
          { text: "Tarifvertrag gilt - 30 Tage Urlaub", consequence: "**Richtig:** Bei Tarifbindung gilt der Tarifvertrag. Arbeitsvertrag kann nur günstiger für Arbeitnehmer abweichen (Günstigkeitsprinzip).", isCorrect: true },
          { text: "Mittelwert: 29 Tage Urlaub", consequence: "**Unsinnig:** Es gibt keine 'Mittelwert-Regel' im Arbeitsrecht.", isCorrect: false },
          { text: "Verhandlungssache zwischen den Parteien", consequence: "**Falsch:** Tarifverträge sind bindend und können nicht beliebig abgeändert werden.", isCorrect: false }
        ]
      }
    ]
  }
