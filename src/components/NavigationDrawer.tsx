...
import { Home, BookOpen, TrendingUp, User, MessageSquare, Users, Shield, Download, MapPin, LogIn, LogOut, Menu, FileText, Activity, ChevronDown, ChevronRight, AlertCircle, BarChart3, GraduationCap, Network, GitBranch, Layers, Database, Calculator, Cpu, Workflow, Binary, Ear } from "lucide-react";
...
const mainItems = [
  ...
  { title: "Bit-/Byte-Rechner", url: "/bit-calculator", icon: Binary },
  { title: "Kommunikationstrainer", url: "/communication-trainer", icon: Ear },
